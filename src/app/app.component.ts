...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Mis Compras', component: MisComprasPage },
      { title: 'Promoción Cerca', component: PromocionCercaPage },
      { title: 'Atención al Cliente', component: AtencionClientePage },
      { title: 'Sobre Nosotros', component: SobreNosotrosPage }
    ];
